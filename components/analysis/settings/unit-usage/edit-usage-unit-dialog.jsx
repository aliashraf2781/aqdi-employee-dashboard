...
export default function EditUsageUnitDialog({unit}) {
  ...
  function editUnit() {
    return axiosInstance.post(`/admin/unit-usages/${unit.id}`, {
      name_ar: unitName,
      ...
      <DialogContent closeButton={false} className="max-w-3xl">
        <DialogHeader>
          <div className='flex items-center justify-between  border-b pb-6'>
            ...
            <h2 className='text-xl font-bold'>تعديل استخدام الوحدة</h2>
