              ...
              <tr key={row.id} className="border-b border-[#F5F5F5] last:border-0 hover:bg-[#fafafa] transition-all">
                <td className="p-[15px_20px]">
                  <div className="flex items-center gap-2">
                    ...
                    <Copy size={10} className="cursor-pointer" onClick={() => {navigator.clipboard.writeText(row.mobile_number)
                ...
                <td className="p-[15px_20px] text-[#616161] text-[13px]">{new Date(row?.date).toLocaleString("ar-EG") || "--"}</td>
                <td className="p-[15px_20px]">
